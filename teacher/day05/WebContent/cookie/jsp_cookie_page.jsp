...
<%
	//- cookie에 데이터 저장하기
	//- id와 pw가 불일치하는 경우에 경고창과 함께 로그인 페이지로 이동시키기
	//  : id가 admin pw가 1234인 경우에만 로그인이라고 가정!!
	...
	if(!"admin".equals(loginId) && !"1234".equals(loginPw)) {
		//out.print("로그인 정보가 틀립니다.");
		%>
		<script>
		alert("로그인 정보가 틀립니다.");
		//javascript를 이용하여 페이지 이동 시키기
...
<%
	...
	//   마치 http의 기본 페이지 이동을 하는 것처럼 이동시키기
